...
public class TestJVFSHelper extends BasicTest {
	...
	protected void tryDumpTestDb( EntityDbJvfsFileFacade fileFacade ) {
		...
		try ( CloseableDAOContext context = new CloseableDAOContextSC( MemJvfsDBHelper.newConnection() ) )  {
	...
	public void testCreateDelete( JVFS jvfs ) throws Exception {
		JFile dbFile1 = jvfs.getJFile( "/test-mount/core-jvfs/db/daogen/daogen-config-jvfs.xml" );
		this.createFile( new File( "./src/test/resources/core-jvfs/db/daogen/daogen-config-jvfs.xml" ) , dbFile1 );
